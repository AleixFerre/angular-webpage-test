...
export class CommandsService {
  commands: Command[] = [
    {
      name: 'adeu',
      description: 'Et despedeix del servidor, adeu!',
      type: 'altres',
      usage: '!adeu',
      aliases: ['bye'],
    },
    {
      ...
      type: 'altres',
      usage: '!ajuda[ nom / tipus de la comanda ]',
      aliases: ['h', 'help'],
    },
    {
      name: 'benvinguda',
    ...
    },
    {
      ...
      type: 'altres',
      usage: '!report< @usuari_a_reportar >',
    },
    {
      name: 'restart',
    ...
    },
    {
      ...
      type: 'banc',
      usage: '!apostar< quantitat/tot > [ multiplicador ]',
      aliases: ['gamble'],
    },
    {
      name: 'apostaramb',
      ...
      type: 'banc',
      usage: '!apostaramb< quantitat/tot > < @usuari >',
      aliases: ['bet'],
    },
    {
      name: 'classificacio',
    ...
    },
    {
      ...
      description:
        'Maquina escurabutxaques de toda la vida.\nNecessites que totes siguin iguals per guanyar recompenses!',
      type: 'banc',
      usage: '!escurabutxaques< quantitat/tot >',
    ...
    },
    {
      ...
      type: 'banc',
      usage: '!pagar< quantitat/tot > < @usuari >',
    ...
    },
    {
      ...
      type: 'entreteniment',
      usage: '!calcula< expressió > or < multiple/M expr1;; expr2>',
    ...
    },
    {
      ...
      type: 'entreteniment',
      usage: '!canvi< quantitat > < de_moneda > < a_moneda >',
      aliases: ['exchange'],
    },
    {
      name: 'captcha',
    ...
    {
      name: 'dau',
      description: 'Tira els daus que vulguis de la mida que vulguis',
      type: 'entreteniment',
      usage: '!dau[ mida ] [ quantitat ]',
      aliases: ['roll', 'dice'],
    },
    {
      name: 'digues',
    ...
    },
    {
      name: 'morsificar',
      description:
        "No saps codi Morse? Aqui tens un des/codificador.\nSi poses un text normal, te'l tradueix a Morse i viceversa.",
      type: 'entreteniment',
      usage: '!morsificar< morse/ASCII >',
      aliases: ['morse', 'demorsificar'],
    },
    {
      name: 'pokedex',
    ...
    },
    {
      ...
      type: 'entreteniment',
      usage: '!pedrapapertisora< rock/paper/scissors >',
      aliases: ['rps'],
    },
    {
      name: 'temps',
    ...
    {
      name: '4enratlla',
      description: 'Joc 2: [BETA] Juga al 4 en ratlla amb els teus amics o contra la IA!',
      type: 'games',
      usage: '!4enratlla',
      aliases: ['connect4', 'play2'],
    },
    {
      name: 'penjat',
    ...
    },
    {
      ...
      type: 'games',
      usage: '!trivial[ quantitat_preguntes ]',
    ...
    },
    {
      ...
      type: 'privat',
      usage: '!adjudicarnivell<nivell, xp, @usuari>',
      aliases: ['setlevel'],
    },
    {
      name: 'nivell',
    ...
    },
    {
      ...
      type: 'mod',
      usage: '!afegirrol< @usuari > < nom_del_rol >',
      aliases: ['addrole', 'giverole'],
    },
    {
      name: 'betar',
      description: 'Beta a un usuari del servidor',
      type: 'mod',
      usage: '!betar< @usuari > [ descripció ]',
      aliases: ['ban', 'beta'],
    },
    {
      name: 'borra',
      ...
      type: 'mod',
      usage: "!borra< quantitat (inclos l'enviat) >",
    ...
    },
    {
      ...
      type: 'mod',
      usage: '!esborrarrol< @usuari > < nom_del_rol >',
    ...
    },
    {
      ...
      type: 'mod',
      usage: '!expulsa< @usuari > [ descripció ]',
    ...
    {
      name: 'barreja',
      description: 'Barreja la cua de reproducció.',
      type: 'musica',
      usage: '!barreja',
      aliases: ['shuffle'],
    },
    {
      name: 'bucle',
      description: 'Alterna el MODE BUCLE. Quan està activat, el bot reproduirà la mateixa cançó una i altra vegada.',
      type: 'musica',
      usage: '!bucle',
      aliases: ['loop', 'repeteix'],
    },
    {
      name: 'cua',
      description: 'Et mostra la llista de reproducció.',
      type: 'musica',
      usage: '!cua[ numero de pàgina ]',
      aliases: ['queue', 'q'],
    },
    {
      name: 'inverteix',
    ...
    },
    {
      name: 'silenci',
      description:
        'Alterna el MODE SILENCI. Aquest fa que el bot no mostri la cançó actual quan passa a la següent cançó.',
      type: 'musica',
      usage: '!silenci',
      aliases: ['silentmode', 'silent'],
    },
    {
      name: 'volum',
      description: 'Posa un nou volum de la reproducció. Et mostra el volum actual si no es passa cap paràmetre.',
      type: 'musica',
      usage: '!volum[ n / earrape ]',
      aliases: ['volume', 'vol'],
    },
    {
      name: 'adjudica',
      ...
      type: 'privat',
      usage: '!adjudica< quantitat > < @usuari >',
    ...
    },
    {
      ...
      type: 'privat',
      usage: '!alerta"changelog" [ or ] < missatge >',
      aliases: ['alert'],
    },
    {
      name: 'generar',
      ...
      type: 'privat',
      usage: '!generar< quantitat > < @usuari >',
